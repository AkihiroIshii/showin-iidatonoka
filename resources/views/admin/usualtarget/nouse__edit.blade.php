<x-app-layout>
    @if(Auth::user()->role == "admin")
        ...
        <div class="maxw-7xl mx-auto px-6">
            ...
            @endif
            <form method="post" action="{{ route('admin.usualtarget.update', $usualtarget) }}">
                @csrf
                @method('patch')
                ...
                <div class="mt-8">
                    <div>
                        ...
                        <input type="text" name="content" class="w-full py-2 border border-gray-300 rounded-md" id="content" value="{{old('content', $usualtarget->content)}}">
                    </div>
                </div>
                <div class="mt-8">
                    <div>
