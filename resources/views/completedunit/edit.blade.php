        ...
        <form method="post" action="{{ route('completedunit.update', $completedunit) }}">
                ...
                <div>
                    ...
                    <select type="string" name="unit_id_mojizou" class="w-auto py-2 border border-gray-300 rounded-md" id="unit_id_mojizou">
                        ...
                        @foreach($mojizous as $mojizou)
                            <option value="{{ $mojizou->id }}" {{ old('unit_id_mojizou', $completedunit->unit_id_mojizou) == $mojizou->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select type="string" name="unit_id_kawaijukuone" class="w-auto py-2 border border-gray-300 rounded-md" id="unit_id_kawaijukuone">
                        ...
                        @foreach($kawaijukuones as $kawaijukuone)
                            <option value="{{ $kawaijukuone->id }}" {{ old('unit_id_kawaijukuone', $completedunit->unit_id_kawaijukuone) == $kawaijukuone->id ? 'selected' : '' }}>
            ...
            <div class="mt-8">
                <div>
                    ...
                    <input type="date" name="target_date" class="w-auto py-2 border border-gray-300 rounded-md" id="target_date" value="{{old('target_date', $completedunit->target_date)}}">
                </div>
            </div>
