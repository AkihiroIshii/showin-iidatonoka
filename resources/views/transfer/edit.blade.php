        ...
        <form method="post" action="{{ route('transfer.update', $transfer) }}">
            ...
            <div>
                ...
                <div class="ml-4">
                    ...
                    <input type="date" name="day_of_absence_1" class="w-auto py-2 border border-gray-300 rounded-md" id="day_of_absence_1" value="{{old('day_of_absence_1', $transfer->day_of_absence_1)}}">
                </div>
                <div class="ml-4">
                    ...
                    <input type="time" name="time_from_absence_1" class="w-auto py-2 border border-gray-300 rounded-md" id="time_from_absence_1" value="{{old('time_from_absence_1', $transfer->time_from_absence_1)}}">
                </div>
                <div class="ml-4">
                    ...
                    <input type="time" name="time_to_absence_1" class="w-auto py-2 border border-gray-300 rounded-md" id="time_to_absence_1" value="{{old('time_to_absence_1', $transfer->time_to_absence_1)}}">
                </div>
                <div class="ml-4">
                    <div>
                        ...
                        <select type="string" name="reason_of_absence_1" class="w-auto py-2 border border-gray-300 rounded-md" id="reason_of_absence_1">
                            ...
                            @foreach($reasons as $reason)
                                <option value="{{ $reason }}" {{ old('reason_of_absence_1', $transfer->reason_of_absence_1) == $reason ? 'selected' : '' }}>
                                    {{ $reason }}
                                </option>
                            @endforeach
                        </select>     
                ...
                <details class="mt-2 border border-gray-300 p-2 rounded-lg">
                    ...
                    <div class="ml-4">
                        ...
                        <input type="date" name="day_of_absence_2" class="w-auto py-2 border border-gray-300 rounded-md" id="day_of_absence_2" value="{{old('day_of_absence_2', $transfer->day_of_absence_2)}}">
                    </div>
                    <div class="ml-4">
                        ...
                        <input type="time" name="time_from_absence_2" class="w-auto py-2 border border-gray-300 rounded-md" id="time_from_absence_2" value="{{old('time_from_absence_2', $transfer->time_from_absence_2)}}">
                    </div>
                    <div class="ml-4">
                        ...
                        <input type="time" name="time_to_absence_2" class="w-auto py-2 border border-gray-300 rounded-md" id="time_to_absence_2" value="{{old('time_to_absence_2', $transfer->time_to_absence_2)}}">
                    </div>
                    <div class="ml-4">
                        <div>
                            ...
                            <select type="string" name="reason_of_absence_2" class="w-auto py-2 border border-gray-300 rounded-md" id="reason_of_absence_2">
                                <option value="">選択してください。</option>
                                @foreach($reasons as $reason)
                                    <option value="{{ $reason }}" {{ old('reason_of_absence_2', $transfer->reason_of_absence_2) == $reason ? 'selected' : '' }}>
                                        {{ $reason }}
                                    </option>
                                @endforeach
                            </select>     
                    ...
                    <div class="ml-4">
                        ...
                        <input type="date" name="day_of_absence_3" class="w-auto py-2 border border-gray-300 rounded-md" id="day_of_absence_3" value="{{old('day_of_absence_3', $transfer->day_of_absence_3)}}">
                    </div>
                    <div class="ml-4">
                        ...
                        <input type="time" name="time_from_absence_3" class="w-auto py-2 border border-gray-300 rounded-md" id="time_from_absence_3" value="{{old('time_from_absence_3', $transfer->time_from_absence_3)}}">
                    </div>
                    <div class="ml-4">
                        ...
                        <input type="time" name="time_to_absence_3" class="w-auto py-2 border border-gray-300 rounded-md" id="time_to_absence_3" value="{{old('time_to_absence_3', $transfer->time_to_absence_3)}}">
                    </div>
                    <div class="ml-4">
                        <div>
                            ...
                            <select type="string" name="reason_of_absence_3" class="w-auto py-2 border border-gray-300 rounded-md" id="reason_of_absence_3">
                                <option value="">選択してください。</option>
                                @foreach($reasons as $reason)
                                    <option value="{{ $reason }}" {{ old('reason_of_absence_3', $transfer->reason_of_absence_3) == $reason ? 'selected' : '' }}>
                                        {{ $reason }}
                                    </option>
                                @endforeach
                            </select>     
                ...
                <div>
                    ...
                    <div class="ml-4">
                        ...
                        <input type="date" name="alternative_day_1" class="w-auto py-2 border border-gray-300 rounded-md" id="alternative_day_1" value="{{old('alternative_day_1', $transfer->alternative_day_1)}}">
                    </div>
                    <div class="ml-4">
                        ...
                        <input type="time" name="time_from_alternative_1" class="w-auto py-2 border border-gray-300 rounded-md" id="time_from_alternative_1" value="{{old('time_from_alternative_1', $transfer->time_from_alternative_1)}}">
                    </div>
                    <div class="ml-4">
                        ...
                        <input type="time" name="time_to_alternative_1" class="w-auto py-2 border border-gray-300 rounded-md" id="time_to_alternative_1" value="{{old('time_to_alternative_1', $transfer->time_to_alternative_1)}}">
                    </div>
                    <details class="mt-2 border border-gray-300 p-2 rounded-lg">
                        <summary class="cursor-pointer text-blue-500 font-semibold">あと２件追加できます。</summary>
                        (2)
                        <div class="ml-4">
                            ...
                            <input type="date" name="alternative_day_2" class="w-auto py-2 border border-gray-300 rounded-md" id="alternative_day_2" value="{{old('alternative_day_2', $transfer->alternative_day_2)}}">
                        </div>
                        <div class="ml-4">
                            ...
                            <input type="time" name="time_from_alternative_2" class="w-auto py-2 border border-gray-300 rounded-md" id="time_from_alternative_2" value="{{old('time_from_alternative_2', $transfer->time_from_alternative_2)}}">
                        </div>
                        <div class="ml-4">
                            ...
                            <input type="time" name="time_to_alternative_2" class="w-auto py-2 border border-gray-300 rounded-md" id="time_to_alternative_2" value="{{old('time_to_alternative_2', $transfer->time_to_alternative_2)}}">
                        </div>
                        (3)
                        <div class="ml-4">
                            ...
                            <input type="date" name="alternative_day_3" class="w-auto py-2 border border-gray-300 rounded-md" id="alternative_day_3" value="{{old('alternative_day_3', $transfer->alternative_day_3)}}">
                        </div>
                        <div class="ml-4">
                            ...
                            <input type="time" name="time_from_alternative_3" class="w-auto py-2 border border-gray-300 rounded-md" id="time_from_alternative_3" value="{{old('time_from_alternative_3', $transfer->time_from_alternative_3)}}">
                        </div>
                        <div class="ml-4">
                            ...
                            <input type="time" name="time_to_alternative_3" class="w-auto py-2 border border-gray-300 rounded-md" id="time_to_alternative_3" value="{{old('time_to_alternative_3', $transfer->time_to_alternative_3)}}">
                        </div>
                    </details>
                    ...
                    @if(Auth::user()->role == "admin")
                        <div class="ml-4">
                            ...
                            <label for="status" class="font-semibold mt-4">ステータス</label>
                            <input type="string" name="status" class="w-auto py-2 border border-gray-300 rounded-md" id="status" value="{{old('status', $transfer->status)}}">
                        </div>
                    @endif
                </div>
