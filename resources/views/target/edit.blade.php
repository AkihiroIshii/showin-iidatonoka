            ...
            <form method="post" action="{{ route('target.update', $target) }}">
                ...
                <div class="mt-8">
                    <div>
                        ...
                        <input type="string" list="list_subject" name="subject" class="w-auto py-2 border border-gray-300 rounded-md" id="subject" value="{{old('subject', $target->subject)}}">
                ...
                <div class="mt-8">
                    <div>
                        ...
                        <input type="string" list="list_no" name="no" class="w-auto py-2 border border-gray-300 rounded-md" id="no" value="{{old('no', $target->no)}}">
                        <datalist id="list_no">
