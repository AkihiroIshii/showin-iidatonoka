        ...
        <form method="post" action="{{ route('exam.store') }}">
            ...
            <div class="mt-8">
                <div>
                    ...
                    <input type="number" name="year" class="w-auto py-2 border border-gray-300 rounded-md" id="year" value="{{old('year')}}">(※半角で入力)
                </div>
            </div>
            ...
            <div class="mt-8">
                <div>
                    ...
                    <input type="number" name="no" class="w-auto py-2 border border-gray-300 rounded-md" id="no" value="{{old('no')}}">(※半角で入力)
                </div>
            </div>
            ...
            <div class="mt-8">
                <div>
                    ...
                    <input type="date" name="exam_date" class="w-auto py-2 border border-gray-300 rounded-md" id="exam_date" value="<?php echo date('Y-m-j');?>">
                </div>
            </div>
            ...
            <div class="mt-8">
                <div>
                    ...
                    <input type="text" name="exam_name" class="w-auto py-2 border border-gray-300 rounded-md" id="exam_name" value="{{old('exam_name')}}">(※半角で入力)
                </div>
            </div>
            ...
            <div class="mt-8">
                <div>
                    ...
                    <input type="number" step="0.1" name="avg_japanese" class="w-auto py-2 border border-gray-300 rounded-md" id="avg_japanese" value="{{old('avg_japanese')}}">点　(※半角で入力)
                </div>
            </div>
            ...
            <div class="mt-8">
                <div>
                    ...
                    <input type="number" step="0.1" name="avg_society" class="w-auto py-2 border border-gray-300 rounded-md" id="avg_society" value="{{old('avg_society')}}">点　(※半角で入力)
                </div>
            </div>
            ...
            <div class="mt-8">
                <div>
                    ...
                    <input type="number" step="0.1" name="avg_math" class="w-auto py-2 border border-gray-300 rounded-md" id="avg_math" value="{{old('avg_math')}}">点　(※半角で入力)
                </div>
            </div>
            ...
            <div class="mt-8">
                <div>
                    ...
                    <input type="number" step="0.1" name="avg_science" class="w-auto py-2 border border-gray-300 rounded-md" id="avg_science" value="{{old('avg_science')}}">点　(※半角で入力)
                </div>
            </div>
            ...
            <div class="mt-8">
                <div>
                    ...
                    <input type="number" step="0.1" name="avg_english" class="w-auto py-2 border border-gray-300 rounded-md" id="avg_english" value="{{old('avg_english')}}">点　(※半角で入力)
                </div>
            </div>
