    ...
    <div class="mx-auto px-6 py-10">
        <div class="mx-auto px-6">
            ...
            <div class="py-4 text-center">
                <a href="{{route('workbook.unit.general_verb1')}}" class="inline-block p-2 rounded shadow bg-blue-200 font-bold">次の問題</a>
            </div>

            <div class="text-center">
                問. 括弧に入る英単語を答えなさい。
                <p class="p-2 text-lg">{{ $question['q'] }}</p>
            </div>
