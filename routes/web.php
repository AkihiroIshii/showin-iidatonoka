...
Route::get('workbook/auxiliary_verb', [WorkbookController::class, 'auxiliary_verb'])
->middleware(['auth', 'verified'])->name('workbook.auxiliary_verb');
...
Route::get('workbook/soc_meiji', [WorkbookController::class, 'soc_meiji'])
->middleware(['auth', 'verified'])->name('workbook.soc_meiji');
Route::get('workbook/soc_meiji2', [WorkbookController::class, 'soc_meiji2'])
->middleware(['auth', 'verified'])->name('workbook.soc_meiji2');
// 国語
...
// 化学
Route::get('workbook/h_sci_significant_figures', [WorkbookController::class, 'h_sci_significant_figures'])
->middleware(['auth', 'verified'])->name('workbook.h_sci_significant_figures');
Route::get('workbook/h_sci_mol', [WorkbookController::class, 'h_sci_mol'])
->middleware(['auth', 'verified'])->name('workbook.h_sci_mol');
// 英語
